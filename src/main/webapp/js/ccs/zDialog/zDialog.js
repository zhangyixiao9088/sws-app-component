...
var IMAGESPATH = mainprePath+'js/ccs/zDialog/skins/blue/'; //图片路径配置，如在有iframe情况下使用，此路径为最顶层窗口页面的相对路径
...
Dialog.prototype.create = function () {
    ...
    var html = '\
  <table id="_DialogTable_{thisID}" width="' + (this.Width + 26) + '" cellspacing="0" cellpadding="0" border="0" style="font-size:15px; line-height:0.8;border-collapse: collapse;">\
    <tr id="_Draghandle_{thisID}" onselectstart="return false;" style="-moz-user-select: -moz-none; ' + (this.Drag ? "cursor: move;" : "") + '">\
      <td width="13" height="50" style="background-image: url({IMAGESPATH}dialog_lt.png) !important;background: url({IMAGESPATH}dialog_lt.gif) ;"><div style="width: 13px;"></div></td>\
      <td height="33" style="background-image:url({IMAGESPATH}dialog_ct.png) !important;background: url({IMAGESPATH}dialog_ct.gif);"><div style="padding: 9px 0 0 4px; float: left; font-family: microsoft yahei; font-weight:normal; color:#fff;"><img align="absmiddle" src="{IMAGESPATH}icon_dialog.gif"/><span id="_Title_{thisID}">' + this.Title + '</span></div>\
        <div id="_ButtonClose_{thisID}" onclick="fixProgress();Dialog.getInstance(\'{thisID}\').cancelButton.onclick.apply(Dialog.getInstance(\'{thisID}\').cancelButton,[]);" onmouseout="this.style.backgroundImage=\'url({IMAGESPATH}dialog_closebtn.gif)\'" onmouseover="this.style.backgroundImage=\'url({IMAGESPATH}dialog_closebtn_over.gif)\'" style="margin: 4px 0 0;*margin-top: 5px; position: relative;top:auto; cursor: pointer; float: right; height: 28px; width: 26px;background-position:0 3px; background: url({IMAGESPATH}dialog_closebtn.gif) 0 0;' + (ielt7 ? "margin-top: 3px;" : "") + (this.ShowCloseButton ? "" : "display:none;") + '"></div></td>\
      <td width="13" height="33" style="background-image: url({IMAGESPATH}dialog_rt.png) !important;background: url({IMAGESPATH}dialog_rt.gif);"><div style="width: 13px;"><a id="_forTab_{thisID}" href="#;"></a></div></td>\
    </tr>\
    <tr valign="top">\
      ...
      <td align="center"><table width="100%" cellspacing="0" cellpadding="0" border="0" style="background-color:#ffffff">\
	...
	' + (function (obj) {
        ...
        return "";
          ...
          <tr id="_ButtonRow_{thisID}" style="' + (this.ShowButtonRow ? "" : "display:none") + '">\
            <td height="36" align="right"><div id="_DialogButtons_{thisID}" style=" height: 40px;">\
                <input type="button" style="font-family: microsoft yahei;height: 40px;width:145px;background-color:#EDEDED;border:none; ' + (this.ShowOkButton ? "" : "display:none") + '"  value="' + this.OkButtonText + '" id="_ButtonOK_{thisID}"/>\
                <input type="button" style="font-family: microsoft yahei;height: 40px;width:145px;background-color:#EDEDED;border:none;  ' + (this.ShowCancelButton ? "" : "display:none") + '"  value="' + this.CancelButtonText + '" onclick="Dialog.getInstance(\'{thisID}\').close();" id="_ButtonCancel_{thisID}"/>\
              </div></td>\
          </tr>\
        </table></td>\
    ...
    if (this.Modal) {
		...
		if(bgdiv.style.display == "none"){
			if(this.Animator){
        		...
        		bgdiv.style.display = "";
				if(isIE){
					bgMask.style.opacity = 0.4;
					bgMask.style.filter = "Alpha(Opacity=40)";
				}
				else{
...
Dialog.prototype.close = function () {
    ...
    if (topWin.Dialog._dialogArray.length > 0) {
        ...
        Dialog.bgDiv.style.zIndex = "19000";
        Dialog.bgDiv.style.display = "none";
        if(HideScrollbar){
	        var topWinBody = topDoc.getElementsByTagName(topDoc.compatMode == "BackCompat" ? "BODY" : "HTML")[0];
...
Dialog.getBgdiv = function () {
    ...
    if (!bgdiv) {
        ...
        bgdiv.style.cssText = "position:absolute;left:0px;top:0px;width:100%;height:100%;z-index:19000";
...
Dialog.alert = function (msg, func, w, h) {
    ...
    diag.InnerHtml = '<table height="100%" border="0" align="center" cellpadding="10" cellspacing="0">\
		<tr><td align="right"><img id="Icon_' + this.ID + '" src="' + IMAGESPATH + 'icon_alert.gif" width="34" height="34" align="absmiddle"></td>\
			<td align="left" id="Message_' + this.ID + '" style="font-family:microsoft yahei;font-size:14pt">' + msg + '</td></tr>\
	</table>';
   diag.show();
