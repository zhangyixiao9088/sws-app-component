...
(function () {
	...
	(function () {
		...
		a.dom._NAME_ATTRS = (function () {
			var d = {cellpadding:"cellPadding", cellspacing:"cellSpacing", colspan:"colSpan", rowspan:"rowSpan", valign:"vAlign", usemap:"useMap", frameborder:"frameBorder"};
			if (a.browser.ie < 8) {
				d["for"] = "htmlFor";
				d["class"] = "className";
			} else {
	...
	var c = BMapLib.InfoBox = function (f, e, d) {
		...
		//this._opts.closeIconUrl = d.closeIconUrl || "./image/secs/map/btn/close.png";
		this._opts.closeIconUrl = d.closeIconUrl || "UIFrame/images/map/close_style2.png";
	...
	}, a.object.extend(c.prototype, {_getCloseIcon:function () {
		var d = "<div style='display:none'><img src='" + this._opts.closeIconUrl + "' align='right' style='position:absolute;right:0px;cursor:pointer;margin:" + this._opts.closeIconMargin + "'/></div>";
		return d;
