...
<!--                                    <img src="AdminLTE-master/img/avatar3.png" class="img-circle" alt="User Image" />-->
                                    <p>
                                ...
                                <li class="user-footer">
                                    <div class="pull-left">
                                        <a href="#" class="btn btn-default btn-flat">ÏêÇé</a>
                                    </div>
                                    <div class="pull-right">
                                        <a href="#" class="btn btn-default btn-flat">ÍË³ö</a>
                                    </div>
                                </li>
                            </ul>
                        </li>
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">                
                ...
                <section class="container-fluid">
                	<div class="row-fluid embed-responsive embed-responsive-4by3">
						<iframe frameBorder="0" class="frm_content0 embed-responsive-item" id="frm_content" name="frm_content" src="AdminLTE-master/index.html"  allowTransparency="true"></iframe>
					</div>
                </section><!-- /.content -->
            </aside><!-- /.right-side -->
        </div><!-- ./wrapper -->
        ...
        <!-- jQuery 2.0.2 -->
        <script src="AdminLTE-master/js/jquery.js"></script>
        <!-- Bootstrap -->
