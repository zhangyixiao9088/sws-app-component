...
public class CkEditor extends AbstractInputComponent implements InputComponent {
	...
	public Set<String> getJsLinks() {
		...
		js.add(this.getScriptFileName("CkEditor/CkeditorSetter.js","utf-8"));
		return js;
	}
	
	@Override
	protected StringBuffer getTemplate(){
		URL templateUrl = ClassLoaderUtil.getResource("assets/vm/default/CkEditor.vm");
