...
public class SubmitButton extends AbstractComponent {
	...
	public String getTempleFileName() {
		...
		String path=this.getBuilder().getTempletBasePath()+File.separator+"SubmitButton.vm";	
		File f=new File(path);
		if(f.exists()){
			return path;
		}
		}
		return AppConstants.getDefaultComponentPath()+File.separator+"SubmitButton.vm";
	}
	@Override
