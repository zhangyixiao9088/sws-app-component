...
public class RadioBoxList extends AbstractComponent implements InputComponent {
	private String data;
	...
	public String getTempleFileName() {
		if (this.getBuilder() != null) {
			String path = this.getBuilder().getTempletBasePath() + File.separator + "RadioBoxList.vm";
			File f = new File(path);
			if (f.exists()) {
				return path;
			}
		}
		return AppConstants.getDefaultComponentPath() + File.separator + "RadioBoxList.vm";
	}
