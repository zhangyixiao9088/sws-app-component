...
public class Select extends AbstractComponent implements InputComponent{
	private String data;
	...
	public String getTempleFileName() {
		...
		String path=this.getBuilder().getTempletBasePath()+File.separator+"Select.vm";	
		File f=new File(path);
		if(f.exists()){
			return path;
		}
		}
		return AppConstants.getDefaultComponentPath()+File.separator+"Select.vm";
	}
